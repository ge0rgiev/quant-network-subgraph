...
export class QntTokenV1 extends ethereum.SmartContract {
  static bind(address: Address): QntTokenV1 {
    return new QntTokenV1("QntTokenV1", address);
  }
  ...
  DECIMAL_ZEROS(): BigInt {
    let result = super.call("DECIMAL_ZEROS", "DECIMAL_ZEROS():(uint256)", []);

    return result[0].toBigInt();
  }

  try_DECIMAL_ZEROS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "DECIMAL_ZEROS",
  ...
  crowdsale(): Address {
    let result = super.call("crowdsale", "crowdsale():(address)", []);

    return result[0].toAddress();
  }

  try_crowdsale(): ethereum.CallResult<Address> {
    let result = super.tryCall("crowdsale", "crowdsale():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
